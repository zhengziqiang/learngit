...
#############################
###### 잡다한 Parameters #####
annotation_path = './data/annotations_demo.pickle'
feat_path = '/home/zzq/srdp_data/feats_demo.npy'
model_path = '/home/zzq/srdp_data/model/'
#############################
...
def test(test_feat='./guitar_player.npy', model_path='/home/zzq/srdp_data/model-82', maxlen=20):
    annotation_data = pd.read_pickle(annotation_path)
    captions = annotation_data['caption'].values
    wordtoix, ixtoword, bias_init_vector = preProBuildWordVocab(captions)
    n_words = len(wordtoix)
